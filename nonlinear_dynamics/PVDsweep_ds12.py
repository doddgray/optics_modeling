...
p_expt = {
    ...
    'α_abs_dB': 0.0/u.cm, # based on Gil-Molina+Dainese papers, reporting 0.019/cm (not in dB/cm)
    ...
    'τ_th_norm_ζ_product': 10,  # τ_th_norm * ζ, inferred from experiment data
