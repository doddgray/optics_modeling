...
p_si = {
    ...
    'c_v': 10./(0.6 * u.degK / u.joule * u.cm**3) # silicon volumetric heat capacity near room temp
}

# heat capacity increased from 1/0.6 to 10/0.6 to check impact on matching with expt data
