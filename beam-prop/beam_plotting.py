...
def plot_profile(q_start_t_r, q_start_s_r, lambda0, elems, cyclical=False,
                 ...
                 show_waists=False, zeroat=0, zunits='mm', runits='um',ax=None,ls='-'):
    """
    ...
    ax.plot(z_mag, prof_t_mag, color='b', label='Tangential beam', linewidth=3, linestyle=ls)
    ax.plot(z_mag, prof_s_mag, color='r', label='Sagittal beam', linewidth=3, linestyle=ls)
